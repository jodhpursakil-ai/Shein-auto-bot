...
# --- FLASK SERVER (Keeps bot alive on Render) ---
app_flask = Flask('')
@app_flask.route('/')
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # SCREENSHOT HANDLER
        ...
        # Shortening callback data to avoid 64-char limit
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if d[0] == 'buy':
        ...
        await context.bot.send_message(int(d[1]), "❌ **𝐏𝐚𝐲𝐦𝐞𝐧𝐭 𝐑𝐞𝐣𝐞𝐜𝐭𝐞𝐝!** ᴄᴏɴᴛᴀᴄᴛ sᴜᴘᴘᴏʀᴛ ɪғ ᴛʜɪs ɪs ᴀ ᴍɪsᴛᴀᴋᴇ.")
